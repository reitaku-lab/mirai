document.addEventListener('DOMContentLoaded', () => {
    ...
    const translations = {
        ja: {
            ...
            'registration.closed': '<p><strong>【受付終了】</strong></p><p>本イベントは、定員に達したため、参加申込の受付を終了いたしました。</p><p>多くの皆さまからお申し込みをいただき、誠にありがとうございました。<br>なお、現在キャンセル待ちの受付は行っておりません。</p><p>参加をご検討いただいていた皆さまには恐れ入りますが、何卒ご理解くださいますようお願い申し上げます。</p>',
